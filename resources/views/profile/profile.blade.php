...
<body class="bg-[#F7F8FA] text-[#3E3E3E] font-sans">
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside id="sidebar"
            class="flex flex-col bg-[#FCFBEF] border-r border-[#E6E6E6] transition-all duration-300 w-72">
            <div>
                <h4 id="sidebarTitle"
                ...
                <nav class="flex flex-col space-y-2 px-3">
                    ...
                    <a href="/profile"
                        class="flex items-center gap-3 bg-[#958433] text-white rounded-full px-5 py-2.5 font-semibold text-sm leading-5">
                        <i class="fas fa-user w-5 text-center"></i>
                        <span class="sidebar-text">Profile</span>
                    </a>
                    <a href="/personal"
                        class="flex items-center gap-3 text-[#3E3E3E] text-sm font-semibold leading-5 px-5 py-2.5 rounded-full hover:bg-[#F8F5EF] transition">
            ...
            <div class="border-t border-[#E6E6E6] px-6 py-6 mt-auto flex flex-col items-center gap-4">
                ...
                <p id="sidebarUserName" class="font-semibold text-[#3E3E3E] text-sm leading-5">{{ Auth::user()->name }}
                </p>
            ...
            <main class="p-6 flex-1 overflow-auto">
                <div class="max-w-xl mx-auto bg-white shadow rounded-lg p-6">
                    ...
                    <form action="/profile/delete" method="POST"
                        onsubmit="return confirm('Are you sure you want to permanently delete this account? All posts and data will be lost.');"
                        class="mt-4">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
