    ...
    <div class="container-fluid">
        <div class="row h-100">
            ...
            <div class="col-md-6 left-panel">
                <div class="card">
                    ...
                    <form id="loginForm" action="/login" method="POST" class="d-none">
                        ...
                        <input type="password" name="loginpassword" class="form-control mb-3" placeholder="Password"
                            required>
            ...
            <div class="col-md-6 right-panel">
                <p class="fs-1 fw-bold" style="font-family: 'Cursive', cursive;">Forklet</p>
                <p class="fs-2" style="font-family: 'Cursive', cursive;">Where the magics begin</p>
            </div>
        </div>
    </div>
